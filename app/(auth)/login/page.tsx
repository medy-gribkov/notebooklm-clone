      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-8 text-foreground dark:text-white w-full h-dvh overflow-hidden">
          ...
          <div className="space-y-5 max-w-lg">
            ...
            <p className="text-body leading-relaxed text-foreground/70 dark:text-white/80 animate-slide-up [animation-delay:100ms]">
              {t("heroDescription")}
            </p>
  ...
  return (
    <div className="flex items-start gap-3 rounded-xl bg-primary/5 dark:bg-white/[0.06] backdrop-blur-sm p-2.5 border border-primary/10 dark:border-white/[0.06]">
      ...
      <div>
        ...
        <p className="text-caption mt-0.5 dark:text-white/70">{description}</p>
      </div>
    </div>
  );
}
